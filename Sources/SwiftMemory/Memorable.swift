...
/// text, images, audio, or any data that was "given" to the agent.
///
/// Given is only saved when the interpreting agent (SubAgent) finds
/// knowledge worth extracting. If nothing is extracted, the Given
/// is discarded.
